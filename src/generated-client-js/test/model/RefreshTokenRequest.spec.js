...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.RefreshTokenRequest();
  });
  ...
  describe('RefreshTokenRequest', function() {
    it('should create an instance of RefreshTokenRequest', function() {
      ...
      //var instance = new OpenApiDefinition.RefreshTokenRequest();
      //expect(instance).to.be.a(OpenApiDefinition.RefreshTokenRequest);
    });
