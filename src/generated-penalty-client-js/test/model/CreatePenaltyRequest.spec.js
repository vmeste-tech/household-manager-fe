...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.CreatePenaltyRequest();
  });
  ...
  describe('CreatePenaltyRequest', function() {
    it('should create an instance of CreatePenaltyRequest', function() {
      // uncomment below and update the code to test CreatePenaltyRequest
      //var instance = new OpenApiDefinition.CreatePenaltyRequest();
      //expect(instance).to.be.a(OpenApiDefinition.CreatePenaltyRequest);
    });
