...
const ApartmentCard = ({ apartmentName, residentsCount, daysLived }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 min-h-[200px] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl animate-slide-up flex flex-col">
      {/* Заголовок */}
