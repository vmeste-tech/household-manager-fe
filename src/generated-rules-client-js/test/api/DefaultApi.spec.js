...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('getApartmentRules', function() {
      it('should call getApartmentRules successfully', function(done) {
        //uncomment below and update the code to test getApartmentRules
        //instance.getApartmentRules(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
