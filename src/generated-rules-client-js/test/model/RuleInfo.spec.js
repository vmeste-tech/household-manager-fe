...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.RuleInfo();
  });
  ...
  describe('RuleInfo', function() {
    it('should create an instance of RuleInfo', function() {
      ...
      //var instance = new OpenApiDefinition.RuleInfo();
      //expect(instance).to.be.a(OpenApiDefinition.RuleInfo);
    });
    ...
    it('should have the property voteResult (base name: "voteResult")', function() {
      // uncomment below and update the code to test the property voteResult
      //var instance = new OpenApiDefinition.RuleInfo();
      //expect(instance).to.be();
    });
