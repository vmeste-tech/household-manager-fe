...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.UpdateRuleRequest();
  });
  ...
  describe('UpdateRuleRequest', function() {
    it('should create an instance of UpdateRuleRequest', function() {
      ...
      //var instance = new OpenApiDefinition.UpdateRuleRequest();
      //expect(instance).to.be.a(OpenApiDefinition.UpdateRuleRequest);
    });
