...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('readNotification', function() {
      it('should call readNotification successfully', function(done) {
        //uncomment below and update the code to test readNotification
        //instance.readNotification(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
